...
export const useRefreshToken = async (
  ...
  try {
    ...
    const response = await fetch(
      "https://qonaq.shamilabilov.live/qonaqol/api/v1/auth/refresh",
      {
        method: "POST",
        headers: {
...
export const handleSignup = async (
  ...
  try {
    ...
    const response = await fetch(
      "https://qonaq.shamilabilov.live/qonaqol/api/v1/auth/signup",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const handleSignIn = async (
  ...
  try {
    ...
    const response = await fetch(
      "https://qonaq.shamilabilov.live/qonaqol/api/v1/auth/signin",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
